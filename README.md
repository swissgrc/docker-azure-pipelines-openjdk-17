...
| unstable    | Latest unstable release (from `develop` branch)                                               | azure-pipelines-dockercli:24.0.6 | 17.0.8.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square)    |
