...
| 17-latest   | Latest stable release (from `main` branch)                                                    | debian:11.6-slim                 | 17.0.7.0 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/17-latest?style=flat-square)   |
