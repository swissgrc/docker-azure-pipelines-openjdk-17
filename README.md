...
| unstable   | Latest unstable release (from `develop` branch)                                               | debian:11.6-slim | 20.10.22   | 17.0.4.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square) |
