...
| unstable    | Latest unstable release (from `develop` branch)                                               | azure-pipelines-dockercli:24.0.7 | 17.0.9   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square)    |
...
|------------------------|----------------------|------------------------------------------------------------------|
| OPENJDK_VERSION        | `17.0.9+9.1`         | Version of Eclipse Temurin OpenJDK installed in the image.       |
