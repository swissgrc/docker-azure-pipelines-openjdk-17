...
| unstable    | Latest unstable release (from `develop` branch)                                               | azure-pipelines-dockercli:25.0.3 | 17.0.9.0 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square)    |
