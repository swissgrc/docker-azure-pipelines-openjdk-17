...
| unstable   | Latest unstable release (from `develop` branch)                                               | debian:11.5-slim | 20.10.20   | 17.0.4  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square) |
...
|------------------------|----------------------|------------------------------------------------------------------|
| DOCKERCLI_VERSION      | `20.10.20`           | Version of Docker CLI installed in the image.                    |
