...
| unstable    | Latest unstable release (from `develop` branch)                                               | azure-pipelines-dockercli:24.0.4 | 17.0.7.0 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square)    |
