...
| unstable   | Latest unstable release (from `develop` branch)                                               | debian:11.4-slim | 20.10.18   | 17.0.4  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-openjdk/unstable?style=flat-square) |
